...
export const OnFlashIcon = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./icon-onflash.png'),
  };
...
export const PersonIcon = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./icon-person.png'),
  };
...
export const CameraIcon = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./icon-camera.png'),
  };

  return Icon(source, style);
};

export const UpIcon = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/arrow-ios-up.png'),
  };

  return Icon(source, style);
};

export const DownIcon = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./eva/arrow-ios-down.png'),
  };

  return Icon(source, style);
};

export const AttachmentIcon = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./icon-attachment.png'),
  };

  return Icon(source, style);
};

export const PhotoGalleryIcon = (style: StyleProp<ImageStyle>): IconElement => {
  const source: IconSource = {
    imageSource: require('./icon-photo-gallery.png'),
  };
