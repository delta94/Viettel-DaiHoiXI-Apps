...
import { AttendanceHallTablet } from './tabs/tablet/attendanceHall.component.tablet';
import { AttendanceGroupTablet } from './tabs/tablet/attendanceGroup.component.tablet';
    ...
    <View style={themedStyle.container}>
      <View style={themedStyle.viewBody}>
        ...
        <View style={themedStyle.viewCard}>
          ...
          />
          {isHallTab() && <AttendanceHallTablet attendances={props.hallAttendance} />}
          {!isHallTab() && <AttendanceGroupTablet groupAttendance={props.groupAttendance} />}
        </View>
      </View>
    </View>
  );
