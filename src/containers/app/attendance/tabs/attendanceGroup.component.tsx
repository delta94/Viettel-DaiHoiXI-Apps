...
import { AttendanceGroupItem } from './attendanceGroupItem.component';
import {
  TabView,
  Tab,
...
export type AttendanceGroupProps = ThemedComponentProps & ComponentProps;

const AttendanceGroupComponent: React.FunctionComponent<AttendanceGroupProps> = (props) => {
...
export const AttendanceGroup = withStyles(AttendanceGroupComponent, (theme: ThemeType) => ({
  container: {
    flex: 1,
  },
  viewSection: {
