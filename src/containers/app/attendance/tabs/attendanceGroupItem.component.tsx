...
export type AttendanceGroupItemProps = ThemedComponentProps & ComponentProps;

const AttendanceGroupItemComponent: React.FunctionComponent<AttendanceGroupItemProps> = (props) => {
...
export const AttendanceGroupItem = withStyles(AttendanceGroupItemComponent, (theme: ThemeType) => ({
  container: {
