...
export type AttendanceHallProps = ThemedComponentProps & ComponentProps;

const AttendanceHallComponent: React.FunctionComponent<AttendanceHallProps> = (props) => {
...
export const AttendanceHall = withStyles(AttendanceHallComponent, (theme: ThemeType) => ({
  container: {
    flex: 1,
