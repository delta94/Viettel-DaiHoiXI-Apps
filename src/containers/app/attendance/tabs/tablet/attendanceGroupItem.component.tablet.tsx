...
export type AttendanceGroupItemTabletProps = ThemedComponentProps & ComponentProps;

const AttendanceGroupItemTabletComponent: React.FunctionComponent<AttendanceGroupItemTabletProps> = (props) => {
...
export const AttendanceGroupItemTablet = withStyles(AttendanceGroupItemTabletComponent, (theme: ThemeType) => ({
  container: {
