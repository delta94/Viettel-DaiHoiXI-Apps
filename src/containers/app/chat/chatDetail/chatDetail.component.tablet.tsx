...
export type ChatDetailTabletProps = ThemedComponentProps & ComponentProps;

const ChatDetailTabletComponent: React.FunctionComponent<ChatDetailTabletProps> = (props) => {
