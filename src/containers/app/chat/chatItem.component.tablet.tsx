...
export type ChatItemTabletProps = ThemedComponentProps & ComponentProps;

const ChatItemTabletComponent: React.FunctionComponent<ChatItemTabletProps> = (props) => {
...
export const ChatItemTablet = withStyles(ChatItemTabletComponent, (theme: ThemeType) => ({
  container: {
