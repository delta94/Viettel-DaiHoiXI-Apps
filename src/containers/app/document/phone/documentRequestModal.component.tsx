...
export type DocumentRequestModalProps = ThemedComponentProps & ComponentProps;

const DocumentRequestModalComponent: React.FunctionComponent<DocumentRequestModalProps> = (props) => {
...
export const DocumentRequestModal = withStyles(DocumentRequestModalComponent, (theme: ThemeType) => ({
  viewModal: {
    alignItems: 'center',
    flex: 1,
  },
