...
export type DocumentTypeProps = ComponentProps & ThemedComponentProps;

const DocumentTypeComponent: React.FunctionComponent<DocumentTypeProps> = (props) => {
...
export const DocumentType = withStyles(DocumentTypeComponent, (theme: ThemeType) => ({
  container: {
    flex: 1,
