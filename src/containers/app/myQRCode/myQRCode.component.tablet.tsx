...
export type MyQRCodeTabletProps = ThemedComponentProps & ComponentProps;

const MyQRCodeTabletComponent: React.FunctionComponent<MyQRCodeTabletProps> = (props) => {
  const { themedStyle } = props;

  return (
    <View style={themedStyle.container}>
      <View style={themedStyle.viewCard}>
        <ProfileInfoV3Tablet deputy={props.user} />
...
export const MyQRCodeTablet = withStyles(MyQRCodeTabletComponent, (theme: ThemeType) => ({
  container: {
    flex: 1,
