...
export type SpeechManagementStatusItemTabletProps = ThemedComponentProps & ComponentProps;

const SpeechManagementStatusItemTabletComponent: React.FunctionComponent<SpeechManagementStatusItemTabletProps> = (props) => {
...
export const SpeechManagementStatusItemTablet = withStyles(SpeechManagementStatusItemTabletComponent, (theme: ThemeType) => ({
  viewWaitSpeech: {
