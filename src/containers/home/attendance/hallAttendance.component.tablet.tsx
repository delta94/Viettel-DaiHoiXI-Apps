...
export type HallAttendanceTabletProps = ThemedComponentProps & ComponentProps;

const HallAttendanceTabletComponent: React.FunctionComponent<HallAttendanceTabletProps> = (props) => {
...
export const HallAttendanceTablet = withStyles(HallAttendanceTabletComponent, (theme: ThemeType) => ({
  container: {
    flex: 1,
    flexDirection: 'row',
  },
