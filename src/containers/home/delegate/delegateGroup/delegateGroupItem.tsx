...
export type DelegateGroupItemProps = ThemedComponentProps & ComponentProps;

const DelegateGroupItemComponent: React.FunctionComponent<DelegateGroupItemProps> = (props) => {
...
export const DelegateGroupItem = withStyles(DelegateGroupItemComponent, (theme: ThemeType) => ({
  container: {
