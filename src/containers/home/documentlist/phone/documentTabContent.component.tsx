...
export type DocumentContentProps = ComponentProps & ThemedComponentProps;

const DocumentContentomponent: React.FunctionComponent<DocumentContentProps> = (props) => {
...
export const DocumentTabContent = withStyles(DocumentContentomponent, (theme: ThemeType) => ({
  container: {
    flex: 1,
