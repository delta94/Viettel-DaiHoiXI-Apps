...
export type MeetingNotificationDetailProps = ThemedComponentProps & ComponentProps;

const MeetingNotificationDetailComponent: React.FunctionComponent<MeetingNotificationDetailProps> = (props) => {
...
export const MeetingNotificationDetail = withStyles(MeetingNotificationDetailComponent, (theme: ThemeType) => ({
  container: {
    flex: 1,
