...
export type MeetingNotificationItemProps = ThemedComponentProps & ComponentProps & ListItemProps;

const MeetingNotificationItemComponent: React.FunctionComponent<MeetingNotificationItemProps> = (props) => {
...
export const MeetingNotificationItem = withStyles(MeetingNotificationItemComponent, (theme: ThemeType) => ({
  container: {
